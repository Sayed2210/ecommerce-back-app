...
export class InitialMigration1770141647254 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."oauth_providers_provider_enum" AS ENUM('google', 'github')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."coupons_type_enum" AS ENUM('percentage', 'fixed', 'free_shipping')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "cart_items" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "quantity" integer NOT NULL, "cart_id" uuid, "product_id" uuid, "variant_id" uuid, CONSTRAINT "PK_6fccf5ec03c172d27a28a82928b" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."inventory_logs_reason_enum" AS ENUM('sale', 'return', 'manual_adjustment', 'restock')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "review_images" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "url" character varying NOT NULL, "altText" character varying, "review_id" uuid, CONSTRAINT "PK_dfb8fbc1b0534f20de489a64358" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_e49a8b7d3f0d2a1e2bf6520a68" ON "products" ("slug", "is_active", "published_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."payments_gateway_enum" AS ENUM('stripe', 'paypal', 'cash_on_delivery')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."orders_payment_method_enum" AS ENUM('stripe', 'cod')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."notifications_type_enum" AS ENUM('order_update', 'promotion', 'system', 'payment', 'shipping')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('customer', 'staff', 'admin')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_e49a8b7d3f0d2a1e2bf6520a68"`,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_e49a8b7d3f0d2a1e2bf6520a68" ON "products" ("slug", "is_active", "published_at") `,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "inventory_logs" ADD CONSTRAINT "FK_5132c139264f494991a44453746" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "inventory_logs" ADD CONSTRAINT "FK_faf34db3d34312b52c881eec8c7" FOREIGN KEY ("created_by") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "order_items" ADD CONSTRAINT "FK_db2d0ea722e16e0fe8ab3bce111" FOREIGN KEY ("variant_id") REFERENCES "product_variants"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "shippings" ADD CONSTRAINT "FK_41c2b0916f597a896492b0b6f92" FOREIGN KEY ("address_id") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "shippings" ADD CONSTRAINT "FK_25bdc73a0a56388a325942bdb9d" FOREIGN KEY ("order_id") REFERENCES "orders"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_67b8be57fc38bda573d2a8513ec" FOREIGN KEY ("shipping_address_id") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "orders" ADD CONSTRAINT "FK_d5bda805951a38147cb93726a77" FOREIGN KEY ("billing_address_id") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "shippings" DROP CONSTRAINT "FK_25bdc73a0a56388a325942bdb9d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "shippings" DROP CONSTRAINT "FK_41c2b0916f597a896492b0b6f92"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "inventory_logs" DROP CONSTRAINT "FK_faf34db3d34312b52c881eec8c7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "inventory_logs" DROP CONSTRAINT "FK_5132c139264f494991a44453746"`,
    );
    await queryRunner.query(
