...
async function seed() {
    try {
        ...
        const categoryDefs = [
            { slug: 'electronics', name: { en: 'Electronics', ar: 'إلكترونيات' }, children: [
                { slug: 'smartphones', name: { en: 'Smartphones', ar: 'هواتف ذكية' } },
                { slug: 'laptops',     name: { en: 'Laptops',     ar: 'لابتوب' } },
                { slug: 'audio',       name: { en: 'Audio',       ar: 'صوتيات' } },
            ]},
            { slug: 'fashion', name: { en: 'Fashion', ar: 'موضة' }, children: [
                { slug: 'mens-clothing',   name: { en: "Men's Clothing",   ar: 'ملابس رجالي' } },
                { slug: 'womens-clothing', name: { en: "Women's Clothing", ar: 'ملابس نسائي' } },
            ]},
            { slug: 'home-garden', name: { en: 'Home & Garden', ar: 'المنزل والحديقة' }, children: [
                { slug: 'furniture',  name: { en: 'Furniture',  ar: 'أثاث' } },
                { slug: 'appliances', name: { en: 'Appliances', ar: 'أجهزة منزلية' } },
            ]},
        ];
        ...
        for (const def of categoryDefs) {
            ...
            if (!parent) {
                parent = categoryRepo.create({ slug: def.slug, name: def.name, isActive: true, metadata: {} });
            ...
            for (const child of def.children ?? []) {
                ...
                if (!childCat) {
                    childCat = categoryRepo.create({ slug: child.slug, name: child.name, parent, isActive: true, metadata: {} });
        ...
        for (const def of brandDefs) {
            ...
            if (!brand) {
                brand = brandRepo.create({ slug: def.slug, name: def.name, isActive: true });
        ...
        const productDefs = [
            {
                ...
                description: { en: 'Latest Apple flagship smartphone', ar: 'أحدث هاتف آبل الرائد' },
                basePrice: 999,
            ...
            },
            {
                ...
                description: { en: 'Premium Android smartphone', ar: 'هاتف أندرويد متميز' },
                basePrice: 799,
                categorySlug: 'smartphones',
                brandSlug: 'samsung',
            ...
            },
            {
                ...
                description: { en: 'Industry-leading noise-cancelling headphones', ar: 'سماعات رأس بإلغاء الضوضاء' },
                basePrice: 349,
                categorySlug: 'audio',
                brandSlug: 'sony',
            ...
            },
            {
                ...
                description: { en: 'Lifestyle shoes with Max Air cushioning', ar: 'حذاء رياضي بتقنية الهواء' },
                basePrice: 150,
            ...
            },
            {
                ...
                description: { en: 'Versatile shelf unit for any room', ar: 'وحدة رفوف متعددة الاستخدامات' },
                basePrice: 89,
