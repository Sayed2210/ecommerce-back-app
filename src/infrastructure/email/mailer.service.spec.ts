    ...
    describe('order-confirmation', () => {
        it('renders with order data', () => {
            const html = render('order-confirmation', {
                ...
                total: '99.99',
                items: [
                    { productName: 'Blue T-Shirt', variantName: 'M / Blue', quantity: 2, unitPrice: '29.99' },
                    { productName: 'Black Hoodie', variantName: null, quantity: 1, unitPrice: '40.01' },
                ],
                shippingAddress: {
    ...
    describe('abandoned-cart', () => {
        it('renders with cart items', () => {
            const html = render('abandoned-cart', {
                name: 'Omar',
                cartItems: [
                    { variant: { product: { name: { en: 'Running Shoes' } }, name: 'Size 42' }, quantity: 1 },
                ],
                cartTotal: '89.99',
    ...
    describe('abandoned-cart-followup', () => {
        it('renders with discount code', () => {
            const html = render('abandoned-cart-followup', {
                userName: 'Nour',
                cartItems: [
                    { variant: { product: { name: { en: 'Leather Bag' } }, name: null }, quantity: 1 },
                ],
                cartTotal: '150.00',
