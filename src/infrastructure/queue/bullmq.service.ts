...
export class BullmqService implements OnModuleInit, OnModuleDestroy {
   ...
   * Email queue
   */
  async addEmailJob<T extends JobData>(
    name: string,
    data: T,
    options?: JobOptions,
  ): Promise<Job<T>> {
  ...
  createEmailWorker(processor: (job: Job) => Promise<any>): Worker {
   ...
   */
  async addImageProcessingJob<T extends JobData>(
    name: string,
    data: T,
    options?: JobOptions,
  ): Promise<Job<T>> {
  ...
  createImageProcessingWorker(processor: (job: Job) => Promise<any>): Worker {
   ...
   */
  async addOrderProcessingJob<T extends JobData>(
    name: string,
    data: T,
    options?: JobOptions,
  ): Promise<Job<T>> {
  ...
  createOrderProcessingWorker(processor: (job: Job) => Promise<any>): Worker {
   ...
   * Notification queue
   */
  async addNotificationJob<T extends JobData>(
    name: string,
    data: T,
    options?: JobOptions,
  ): Promise<Job<T>> {
  ...
  createNotificationWorker(processor: (job: Job) => Promise<any>): Worker {
   ...
   */
  async addAnalyticsJob<T extends JobData>(
    name: string,
    data: T,
    options?: JobOptions,
  ): Promise<Job<T>> {
  ...
  createAnalyticsWorker(processor: (job: Job) => Promise<any>): Worker {
