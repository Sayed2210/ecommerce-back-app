...
describe('StaffService', () => {
    ...
    describe('create', () => {
        const dto = { employeeId: 'EMP-001', userId: 'u1', department: 'Engineering' };
    ...
    describe('update', () => {
        it('updates staff fields and saves', async () => {
            ...
            staffRepository.findOne.mockResolvedValue(staff);
            staffRepository.save.mockResolvedValue({ ...staff, department: 'Engineering' });

            const result = await service.update('s1', { department: 'Engineering' } as any);
