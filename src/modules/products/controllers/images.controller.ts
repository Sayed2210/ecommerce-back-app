...
export class ProductImagesController {
  ...
  @ApiOperation({
    ...
    description: 'Get all images for a product ordered by displayOrder',
  })
  ...
  @ApiOperation({
    ...
    description: 'Upload a product image to S3 (JPEG, PNG, WebP — max 5 MB)',
  })
  @ApiParam({ name: 'productId', description: 'Product ID' })
  ...
  @ApiOperation({
    ...
    description: 'Delete an image from S3 and the database',
  })
  @ApiParam({ name: 'productId', description: 'Product ID' })
  ...
  @ApiOperation({
    ...
    description: 'Mark an image as the primary product image',
  })
  @ApiParam({ name: 'productId', description: 'Product ID' })
  @ApiParam({ name: 'imageId', description: 'Image ID' })
