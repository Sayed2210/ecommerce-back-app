...
describe('ElasticsearchService', () => {
    ...
    describe('ensureIndex', () => {
        ...
        it('logs a warning and does not throw when Elasticsearch is unreachable', async () => {
            mockEsClient.indices.exists.mockRejectedValue(new Error('connection refused'));
    ...
    describe('deleteProduct', () => {
        it('deletes the document by product id', async () => {
            ...
            expect(mockEsClient.delete).toHaveBeenCalledWith({ index: 'products', id: 'prod-1' });
        });
        ...
        it('does not throw when the product was never indexed (404)', async () => {
            ...
            await expect(service.deleteProduct('prod-missing')).resolves.not.toThrow();
        });
        ...
        it('re-throws non-404 errors', async () => {
            ...
            await expect(service.deleteProduct('prod-1')).rejects.toThrow('ES cluster not available');
        });
    });
